...
include_once("LIB/LIB_http.php");			// http library
include_once("LIB/LIB_parse.php");			// parse library
include_once("LIB/LIB_resolve_addresses.php");	// address resolution library
include_once("LIB/LIB_exclusion_list.php");		// list of excluded keywords
include_once("LIB/LIB_simple_spider.php");		// spider routines used by this app.
