...
<body>
    <div class="container">
     <?php include_once('nav.php'); ?>
      ...
      <div class="jumbotron">
		<form role="form" method="POST" action="" style="direction:rtl;width:200px;float:right">
		  ...
		  <button type="submit" class="btn btn-default"  >  &nbsp;&nbsp  بحث  &nbsp;&nbsp </button>
		</form>
		<br/>
...
function setCondition($params){
	...
	if($result =$mysqli->query("SELECT * FROM `adds`")) {
		echo "<form name='ads' action='".$_SERVER['PHP_SELF']."' method='post'><table class='table table-bordered'>
								 <thead>
